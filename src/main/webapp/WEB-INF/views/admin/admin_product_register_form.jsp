          ...
          <div class="col-md-8 ps-md-4">
            <div class="row g-3">
              <div class="col-md-8">
                ...
                <input type="text" name="title" class="form-control" value="${product.title}" placeholder="예: [NHN] 시그니처 텀블러" required>
              </div>
              <div class="col-md-4">
              ...
              <div class="col-12">
                ...
                <input type="text" name="vendor" class="form-control" value="${product.vendor}" placeholder="제조사명을 입력하세요">
              </div>
              <div class = "col-md-6">
                <label class = "form-label fw-bold">바코드 (EAN)</label>
                <input type ="text" name="ean" class="form-control" value="${product.ean}" minlength="13" maxlength="13" placeholder="13자리 숫자">
            </div>
          </div>
        </div>
        <hr class="my-4">
