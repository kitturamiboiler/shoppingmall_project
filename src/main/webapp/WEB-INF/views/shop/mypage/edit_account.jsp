    ...
    <form method="post" action="/editAccountAction.do">
      ...
      <div class="form-floating mb-2">
        <input type="text" name="user_name" class="form-control" id="user_name"
               value="${user.userName}" placeholder="이름" required>
        <label for="user_name">이름</label>
      </div>

      <div class="form-floating mb-2">
        <input type="password" name="user_password" class="form-control" id="user_password"
               value="${user.userPassword}" placeholder="패스워드" required>
        <label for="user_password">패스워드</label>
      </div>

      <div class="form-floating mb-2">
        <input type="text" name="user_birth" class="form-control" id="user_birth"
               value="${user.userBirth}" placeholder="생년월일(8자리)" maxlength="8" required
